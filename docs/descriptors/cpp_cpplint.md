...
Syntax: cpplint.py [--verbose=#] [--output=emacs|eclipse|vs7|junit|sed|gsed]
  ...
  Default linted extensions are ['c', 'h', 'cuh', 'hxx', 'cu', 'cc', 'h++', 'c++', 'hpp', 'cxx', 'cpp', 'hh'].
  ...
  Flags:
    ...
    extensions=extension,extension,...
      ...
      Examples:
        --extensions=c,h,cuh,hxx,cu,cc,h++,c++,hpp,cxx,cpp,hh
    ...
    headers=x,y,...
     ...
     (by default, only files with extensions {'h', 'cuh', 'hxx', 'h++', 'hpp', 'hh'} will be assumed to be headers)

      Examples:
        --headers=h,cuh,hxx,h++,hpp,hh
        --headers=hpp,hxx
        --headers=hpp
